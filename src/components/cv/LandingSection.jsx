...
export default function LandingSection({ onStart, onImport }) {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 py-20 bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="relative max-w-7xl w-full mx-auto grid lg:grid-cols-[1fr,320px] gap-12 items-center">
        {/* Left: Main Content */}
        <div>
          {/* Trust Badge */}
        ...
        <div className="hidden lg:block space-y-6">
          ...
          <div className="space-y-4">
            <div className="bg-white/60 backdrop-blur-sm border border-gray-200 rounded-lg p-4 shadow-sm">
              <p className="text-sm text-gray-700 mb-2">"Landed a Big4 role in 3 weeks"</p>
              <p className="text-xs text-gray-500">Sarah M., Senior Consultant</p>
            </div>
            <div className="bg-white/60 backdrop-blur-sm border border-gray-200 rounded-lg p-4 shadow-sm">
              <p className="text-sm text-gray-700 mb-2">"Perfect format, passed every ATS"</p>
              <p className="text-xs text-gray-500">David L., Project Manager</p>
            </div>
          </div>

          {/* CV Preview Thumbnails */}
          <div className="relative">
            <div className="text-xs text-gray-500 mb-2 font-medium">Sample CVs:</div>
            <div className="grid grid-cols-2 gap-2">
              <div className="aspect-[1/1.4] bg-white border border-gray-200 rounded-md shadow-sm overflow-hidden">
                <div className="p-3 space-y-1.5 opacity-60">
                  <div className="h-2 bg-gray-900 w-3/4 rounded" />
              ...
              <div className="aspect-[1/1.4] bg-white border border-gray-200 rounded-md shadow-sm overflow-hidden">
                <div className="p-3 space-y-1.5 opacity-60">
                  <div className="h-2 bg-gray-900 w-2/3 rounded" />
                  <div className="h-1.5 bg-gray-400 w-1/2 rounded" />
                  <div className="pt-2 space-y-1">
                    <div className="h-1 bg-gray-300 w-full rounded" />
